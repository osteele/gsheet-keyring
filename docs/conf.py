...
htmlhelp_basename = 'gsheet_keyringdoc'
...
latex_documents = [
    (master_doc, 'gsheet-keyring.tex', 'gsheet-keyring Documentation',
...
man_pages = [
    (master_doc, 'gsheet-keyring', 'gsheet-keyring Documentation',
     [author], 1)
]
